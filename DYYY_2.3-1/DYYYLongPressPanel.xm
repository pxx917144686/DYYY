...
- (NSArray *)dataArray {
    ...
    // PIP 功能开关检查
    BOOL enablePip = enableDownload && [[NSUserDefaults standardUserDefaults] boolForKey:@"DYYYLongPressPip"];
    ...
    hasAnyFeatureEnabled = enableSaveVideo || enableSaveCover || enableSaveAudio || enableSaveCurrentImage || enableSaveAllImages || 
                           ...
                           enableTimerClose || enableCreateVideo || enableFLEX || enablePip || enableDownload;
    ...
    BOOL hideSaveToAlbum = [[NSUserDefaults standardUserDefaults] boolForKey:@"DYYYHidePanelSaveToAlbum"];
    BOOL hideImageSearch = [[NSUserDefaults standardUserDefaults] boolForKey:@"DYYYHidePanelImageSearch"];
...
%ctor {
    ...
    // 灰度测试-面板默认值
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"DYYYEnableModernPanel"] == nil) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"DYYYEnableModernPanel"];
    }
    
    // 面板玻璃效果默认值
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"DYYYLongPressPanelBlur"] == nil) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"DYYYLongPressPanelBlur"];
    }
    
    // 面板深色模式默认值
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"DYYYLongPressPanelDark"] == nil) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"DYYYLongPressPanelDark"];
    }
    ...
    // PIP 功能默认值
    if ([[NSUserDefaults standardUserDefaults] objectForKey:@"DYYYLongPressPip"] == nil) {
        [[NSUserDefaults standardUserDefaults] setBool:YES forKey:@"DYYYLongPressPip"];
        [[NSUserDefaults standardUserDefaults] synchronize];
    }
