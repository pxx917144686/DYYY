...
@interface DYYYGlassFlexView : UIVisualEffectView
...
// DYYY 统一使用的功能键，并兼容历史功能键迁移。
FOUNDATION_EXPORT NSString * const DYYYKeyCommentHideBottomBar;
FOUNDATION_EXPORT NSString * const DYYYKeyCommentMediaCleanBottomBar;
FOUNDATION_EXPORT NSString * const DYYYKeyCommentGlass;
FOUNDATION_EXPORT NSString * const DYYYKeyCommentGlassClear;
FOUNDATION_EXPORT NSString * const DYYYKeySharePanelGlass;
FOUNDATION_EXPORT NSString * const DYYYKeySharePanelGlassClear;
FOUNDATION_EXPORT NSString * const DYYYKeyInnerNotiGlass;
FOUNDATION_EXPORT NSString * const DYYYKeyInnerNotiGlassClear;
FOUNDATION_EXPORT NSString * const DYYYKeyInnerNotiCorner;
FOUNDATION_EXPORT NSString * const DYYYKeyGlassTabBar;
FOUNDATION_EXPORT NSString * const DYYYKeyGlassTabBarClear;
FOUNDATION_EXPORT NSString * const DYYYKeyAudioVizPosition;
FOUNDATION_EXPORT NSString * const DYYYKeyAudioVizStyle;
FOUNDATION_EXPORT NSString * const DYYYKeyDetailHideBottomBar;
...
NSString * _Nullable DYYYCachedString(NSString *key);
NSInteger DYYYCachedInteger(NSString *key);
CGFloat DYYYCachedFloat(NSString *key);
NSArray<NSString *> *DYYYCachedKeywordList(NSString *key);
...
UIViewController * _Nullable DYYYChildControllerNamed(UIViewController *controller, NSString *className);
BOOL DYYYColorIsOpaqueBlack(UIColor *color);
UIColor * _Nullable DYYYGlassTintForStyle(UIUserInterfaceStyle style);
UIView * _Nullable DYYYCellContentView(UIView *view);
CGFloat DYYYFullCellHeight(UIView *view);

UIView * _Nullable DYYYGlassFlexResolvedSource(UIView *glass);
BOOL DYYYGlassFlexInstalled(UIView *glass);

/// 控制器链是否属于聊天/私信上下文（对话页共享视频布局豁免用）
