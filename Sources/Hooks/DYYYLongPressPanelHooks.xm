...
//  DYYY
//
//  长按面板主面板 hook：AWELongPressPanelViewGroupModel 自定义组属性 +
//  AWEModernLongPressPanelTableViewController（ColorPickerGroup）。
//
...
%ctor {
    ...
    // 初始化本文件的未分组 hook（AWELongPressPanelViewGroupModel 属性与存取器）
    %init(_ungrouped);
