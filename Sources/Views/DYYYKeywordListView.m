...
- (instancetype)initWithTitle:(NSString *)title keywords:(NSArray *)keywords {
  if (self = [super initWithFrame:UIScreen.mainScreen.bounds]) {
    ...
    self.backgroundColor = DYYYThemeBackgroundColor();

    BOOL isDarkMode = DYYYThemeIsDark();

    // 创建模糊效果背景
    self.blurView = [[UIVisualEffectView alloc]
        initWithEffect:[UIBlurEffect effectWithStyle:DYYYThemeBlurStyle()]];
    self.blurView.frame = self.bounds;
    self.blurView.alpha = DYYYThemeBlurAlpha();
    ...
    self.contentView.backgroundColor = DYYYThemeSurfaceColor();
    ...
    self.titleLabel.textColor = DYYYThemePrimaryTextColor();
    ...
    self.keywordsTableView.separatorColor = DYYYThemeSeparatorColor();
    ...
    [self.addButton setTitleColor:DYYYThemeAccentColor()
    ...
    contentButtonSeparator.backgroundColor = DYYYThemeSeparatorColor();
    ...
    [self.cancelButton setTitleColor:DYYYThemeSecondaryTextColor()
    ...
    buttonSeparator.backgroundColor = DYYYThemeSeparatorColor();
    ...
    [self.confirmButton setTitleColor:DYYYThemePrimaryTextColor()
                             forState:UIControlStateNormal];
...
- (UITableViewCell *)tableView:(UITableView *)tableView
  ...
  if (!cell) {
    ...
    // 设置删除按钮颜色
    [deleteButton setTintColor:DYYYThemeSecondaryTextColor()];
    ...
    cell.textLabel.textColor = DYYYThemePrimaryTextColor();
  }
