...
- (instancetype)initWithTitle:(NSString *)title defaultText:(NSString *)defaultText placeholder:(NSString *)placeholder {
    if (self = [super initWithFrame:UIScreen.mainScreen.bounds]) {
        ...
        self.blurView = [[UIVisualEffectView alloc] initWithEffect:[UIBlurEffect effectWithStyle:DYYYThemeBlurStyle()]];
        ...
        self.inputTextField.textColor = DYYYThemePrimaryTextColor();
        
        // 使用自定义占位符文本，根据模式设置占位符颜色
        NSString *placeholderString = placeholder.length > 0 ? placeholder : @"请输入内容";
        UIColor *placeholderColor = DYYYThemeSecondaryTextColor();
        ...
        self.inputTextField.tintColor = DYYYThemeAccentColor();
        ...
        UIColor *cancelColor = DYYYThemeSecondaryTextColor();
        ...
        UIColor *confirmColor = DYYYThemePrimaryTextColor();
