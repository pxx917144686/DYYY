...
- (instancetype)initWithTitle:(NSString *)title text:(NSString *)text {
  if (self = [super initWithFrame:UIScreen.mainScreen.bounds]) {
    ...
    self.keywordFilterButton.tintColor = DYYYThemeAccentColor();
    ...
    self.selectionPreviewLabel.textColor = DYYYThemeAccentColor();
...
- (void)setupCharacterButtons {
  ...
  UIColor *buttonBackgroundColor = isDarkMode ?
      ...
      [UIColor whiteColor];
  UIColor *buttonTextColor = DYYYThemePrimaryTextColor();
