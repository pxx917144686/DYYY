...
@interface DYYYOSCache <KeyType, ObjectType> : NSCache <NSFastEnumeration>
...
@protocol DYYYOSCacheDelegate <NSCacheDelegate>
@optional

- (BOOL)cache:(DYYYOSCache *)cache shouldEvictObject:(id)entry;
- (void)cache:(DYYYOSCache *)cache willEvictObject:(id)entry;
