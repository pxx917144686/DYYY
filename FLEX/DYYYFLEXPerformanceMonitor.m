...
@interface DYYYFLEXPerformanceMonitor ()
...
@implementation DYYYFLEXPerformanceMonitor

+ (instancetype)sharedInstance {
    static DYYYFLEXPerformanceMonitor *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[DYYYFLEXPerformanceMonitor alloc] init];
    });
    return instance;
}
