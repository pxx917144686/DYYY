...
@interface DYYYFLEXLookinViewNode : NSObject
@property (nonatomic, weak) UIView *view;
@property (nonatomic, strong) NSArray<DYYYFLEXLookinViewNode *> *children;
@property (nonatomic, weak) DYYYFLEXLookinViewNode *parent;
...
@interface DYYYFLEXLookinInspector : NSObject

@property (nonatomic, weak) id<FLEXLookinInspectorDelegate> delegate;
@property (nonatomic, assign) FLEXLookinViewMode viewMode;
@property (nonatomic, strong, readonly) NSArray<DYYYFLEXLookinViewNode *> *viewHierarchy;
