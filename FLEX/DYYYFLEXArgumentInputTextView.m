//
//  DYYYFLEXArgumentInputTextView.m
//  FLEXInjected
//
...
#import "DYYYFLEXArgumentInputTextView.h"
#import "DYYYFLEXUtility.h"

@interface DYYYFLEXArgumentInputTextView ()
...
@implementation DYYYFLEXArgumentInputTextView
...
- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    ...
    if (self) {
        ...
        self.inputTextView.backgroundColor = DYYYFLEXColor.secondaryGroupedBackgroundColor;
        ...
        if (@available(iOS 11, *)) {
            ...
            self.inputTextView.layer.borderColor = DYYYFLEXColor.borderColor.CGColor;
        }

        self.placeholderLabel = [UILabel new];
        self.placeholderLabel.font = self.inputTextView.font;
        self.placeholderLabel.textColor = DYYYFLEXColor.deemphasizedTextColor;
