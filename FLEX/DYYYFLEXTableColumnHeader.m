...
@interface DYYYFLEXTableColumnHeader ()
@property (nonatomic, readonly) UILabel *arrowLabel;
@property (nonatomic, readonly) UIView *lineView;
@end

@implementation DYYYFLEXTableColumnHeader

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = DYYYFLEXColor.secondaryBackgroundColor;
        ...
        _lineView.backgroundColor = DYYYFLEXColor.hairlineColor;
