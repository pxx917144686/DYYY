...
@class DYYYFLEXNetworkTransaction, DYYYFLEXHTTPTransaction, DYYYFLEXWebsocketTransaction, DYYYFLEXFirebaseTransaction;
...
@interface DYYYFLEXNetworkRecorder : NSObject

/// 通常情况下，整个应用程序只需要一个记录器。
@property (nonatomic, readonly, class) DYYYFLEXNetworkRecorder *defaultRecorder;
...
@property (nonatomic, readonly) NSArray<DYYYFLEXHTTPTransaction *> *HTTPTransactions;
/// FLEXWebsocketTransaction对象数组，按开始时间排序，最新的排在前面。
@property (nonatomic, readonly) NSArray<DYYYFLEXWebsocketTransaction *> *websocketTransactions API_AVAILABLE(ios(13.0));
/// FLEXFirebaseTransaction对象数组，按开始时间排序，最新的排在前面。
@property (nonatomic, readonly) NSArray<DYYYFLEXFirebaseTransaction *> *firebaseTransactions;
