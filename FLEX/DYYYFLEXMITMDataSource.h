...
@interface DYYYFLEXMITMDataSource<__covariant TransactionType> : NSObject
...
- (void)reloadData:(void (^_Nullable)(DYYYFLEXMITMDataSource *dataSource))completion;
- (void)filter:(NSString *)searchString completion:(void(^_Nullable)(DYYYFLEXMITMDataSource *dataSource))completion;
