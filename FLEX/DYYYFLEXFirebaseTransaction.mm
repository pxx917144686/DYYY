...
+ (instancetype)initiator:(id)initiator requestType:(FLEXFIRRequestType)type extraData:(id)data {
    DYYYFLEXFirebaseTransaction *fire = [DYYYFLEXFirebaseTransaction withStartTime:NSDate.date];
...
+ (instancetype)setData:(FIRDocumentReference *)initiator data:(NSDictionary *)data
    ...
    DYYYFLEXFirebaseSetDataInfo *info = [DYYYFLEXFirebaseSetDataInfo data:data merge:merge mergeFields:mergeFields];
...
- (DYYYFLEXFirebaseSetDataInfo *)setDataInfo {
