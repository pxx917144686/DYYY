...
@interface DYYYFLEXDoKitLogViewer ()
@property (nonatomic, strong) NSMutableArray<DYYYFLEXDoKitLogEntry *> *mutableLogEntries;
@property (nonatomic, strong) dispatch_queue_t logQueue;
@end

@implementation DYYYFLEXDoKitLogViewer

+ (instancetype)sharedInstance {
    static DYYYFLEXDoKitLogViewer *instance = nil;
...
- (NSMutableArray<DYYYFLEXDoKitLogEntry *> *)logEntries {
...
- (void)parseLogLine:(NSString *)line {
    // 简单的日志解析
    DYYYFLEXDoKitLogEntry *entry = [[DYYYFLEXDoKitLogEntry alloc] init];
...
- (NSString *)exportLogsAsString {
    ...
    for (DYYYFLEXDoKitLogEntry *entry in self.logEntries) {
