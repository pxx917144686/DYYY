...
@implementation DYYYFHSRangeSlider
...
//        iv.userInteractionEnabled = YES;
    ...
    _track = newSubviewImageView(DYYYFLEXResources.rangeSliderTrack);
    _fill = newSubviewImageView(DYYYFLEXResources.rangeSliderFill);
    _leftHandle = newSubviewImageView(DYYYFLEXResources.rangeSliderLeftHandle);
    _rightHandle = newSubviewImageView(DYYYFLEXResources.rangeSliderRightHandle);
}
