//
//  DYYYFLEXFieldEditorViewController.h
//  FLEX
//
...
@interface DYYYFLEXFieldEditorViewController : DYYYFLEXVariableEditorViewController

/// @return nil if the property is readonly or if the type is unsupported
+ (nullable instancetype)target:(id)target property:(DYYYFLEXProperty *)property commitHandler:(void(^_Nullable)(void))onCommit;
/// @return nil if the ivar type is unsupported
+ (nullable instancetype)target:(id)target ivar:(DYYYFLEXIvar *)ivar commitHandler:(void(^_Nullable)(void))onCommit;
