...
@interface DYYYFLEXColorPickerTool()
...
@implementation DYYYFLEXColorPickerTool

+ (instancetype)sharedInstance {
    static DYYYFLEXColorPickerTool *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[DYYYFLEXColorPickerTool alloc] init];
    });
    return instance;
}
