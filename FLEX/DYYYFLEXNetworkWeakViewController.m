//
//  DYYYFLEXNetworkWeakViewController.m
//  FLEX
//
...
#import "DYYYFLEXNetworkWeakTester.h"

@interface DYYYFLEXNetworkWeakViewController ()

@property (nonatomic, strong) NSArray *networkTypesList;

@end

@implementation DYYYFLEXNetworkWeakViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // 检查当前选中的网络类型
    FLEXNetworkWeakType currentType = [DYYYFLEXNetworkWeakTester sharedInstance].currentWeakType;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (type == FLEXNetworkWeakTypeNone) {
        [[DYYYFLEXNetworkWeakTester sharedInstance] stopWeakNetwork];
    } else {
        [[DYYYFLEXNetworkWeakTester sharedInstance] startWeakNetworkWithType:type];
    }
