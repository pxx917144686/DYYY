...
@interface DYYYFLEXNetworkTransaction : NSObject {
    @protected
...
/// 此类使用子类提供的URL生成描述。
@interface DYYYFLEXURLTransaction : DYYYFLEXNetworkTransaction
...
@interface DYYYFLEXHTTPTransaction : DYYYFLEXURLTransaction
...
@interface DYYYFLEXWebsocketTransaction : DYYYFLEXURLTransaction
...
@interface DYYYFLEXFirebaseSetDataInfo : NSObject
/// 设置的数据
...
@interface DYYYFLEXFirebaseTransaction : DYYYFLEXNetworkTransaction
...
/// 仅用于"设置数据"类型
@property (nonatomic, readonly) DYYYFLEXFirebaseSetDataInfo *setDataInfo;
/// 仅用于"更新数据"类型
