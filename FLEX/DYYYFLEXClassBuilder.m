...
@interface DYYYFLEXClassBuilder ()
@property (nonatomic) NSString *name;
@end

@implementation DYYYFLEXClassBuilder
...
- (NSArray *)addMethods:(NSArray *)methods {
    ...
    for (DYYYFLEXMethodBase *m in methods) {
...
- (NSArray *)addProperties:(NSArray *)properties {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (DYYYFLEXProperty *p in properties) {
        unsigned int pcount;
...
- (NSArray *)addProtocols:(NSArray *)protocols {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (DYYYFLEXProtocol *p in protocols) {
...
- (NSArray *)addIvars:(NSArray *)ivars {
    ...
    NSMutableArray *failed = [NSMutableArray new];
    for (DYYYFLEXIvarBuilder *ivar in ivars) {
...
@implementation DYYYFLEXIvarBuilder
