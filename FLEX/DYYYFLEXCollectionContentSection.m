//
//  DYYYFLEXCollectionContentSection.m
//  FLEX
//
...
@interface DYYYFLEXCollectionContentSection ()
...
@implementation DYYYFLEXCollectionContentSection
...
+ (id)forCollection:(id<FLEXCollection>)collection {
    DYYYFLEXCollectionContentSection *section = [self new];
...
- (NSString *)describe:(id)object {
    return [DYYYFLEXRuntimeUtility summaryForObject:object];
}
...
- (UIViewController *)viewControllerToPushForRow:(NSInteger)row {
    return [DYYYFLEXObjectExplorerFactory explorerViewControllerForObject:[self objectForRow:row]];
}
