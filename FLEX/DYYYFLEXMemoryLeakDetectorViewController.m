...
@interface DYYYFLEXMemoryLeakDetectorViewController () <UITableViewDataSource, UITableViewDelegate>
...
@implementation DYYYFLEXMemoryLeakDetectorViewController
...
- (void)detectionSwitchChanged:(UISwitch *)sender {
    DYYYFLEXDoKitMemoryLeakDetector *detector = [DYYYFLEXDoKitMemoryLeakDetector sharedInstance];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row < self.leakInfos.count) {
        ...
        if ([leakInfo isKindOfClass:[DYYYFLEXDoKitLeakInfo class]]) {
            DYYYFLEXDoKitLeakInfo *info = (DYYYFLEXDoKitLeakInfo *)leakInfo;
