...
@interface DYYYFLEXTableContentViewController () <
...
@property (nonatomic) DYYYFLEXMultiColumnTableView *multiColumnView;
@end

@implementation DYYYFLEXTableContentViewController
...
- (DYYYFLEXMultiColumnTableView *)multiColumnView {
    if (!_multiColumnView) {
        _multiColumnView = [[DYYYFLEXMultiColumnTableView alloc]
...
- (CGFloat)multiColumnTableView:(DYYYFLEXMultiColumnTableView *)tableView
...
- (void)multiColumnTableView:(DYYYFLEXMultiColumnTableView *)tableView didSelectRow:(NSInteger)row {
    ...
    [DYYYFLEXAlert makeAlert:^(DYYYFLEXAlert *make) {
        ...
        make.button(@"专注于行").handler(^(NSArray<NSString *> *strings) {
            UIViewController *focusedRow = [DYYYFLEXTableRowDataViewController
...
- (void)multiColumnTableView:(DYYYFLEXMultiColumnTableView *)tableView
...
- (void)executeStatementAndShowResult:(NSString *)statement
    ...
    DYYYFLEXSQLResult *result = [self.databaseManager executeStatement:statement];
