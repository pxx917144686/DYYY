#import "DYYYFLEXViewBorderViewController.h"
#import "FLEXCompatibility.h"
#import "DYYYFLEXDoKitVisualTools.h"

@interface DYYYFLEXViewBorderViewController ()
...
@implementation DYYYFLEXViewBorderViewController
...
- (void)borderSwitchChanged:(UISwitch *)sender {
    if (sender.isOn) {
        [[DYYYFLEXDoKitVisualTools sharedInstance] showViewBorders];
    } else {
        [[DYYYFLEXDoKitVisualTools sharedInstance] hideViewBorders];
    }
}

- (void)layoutSwitchChanged:(UISwitch *)sender {
    if (sender.isOn) {
        [[DYYYFLEXDoKitVisualTools sharedInstance] showLayoutBounds];
    } else {
        [[DYYYFLEXDoKitVisualTools sharedInstance] hideLayoutBounds];
    }
}

- (void)rulerSwitchChanged:(UISwitch *)sender {
    if (sender.isOn) {
        [[DYYYFLEXDoKitVisualTools sharedInstance] showRuler];
    } else {
        [[DYYYFLEXDoKitVisualTools sharedInstance] hideRuler];
    }
}
