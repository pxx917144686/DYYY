    ...
    if (url) {
        if (@available(iOS 10, *)) {
            [app openURL:url options:@{
                ...
                if (!success) {
                    [DYYYFLEXAlert showAlert:@"没有通用链接处理程序"
        ...
        [DYYYFLEXAlert showAlert:@"错误" message:@"无效的 URL" from:host];
    }
}
