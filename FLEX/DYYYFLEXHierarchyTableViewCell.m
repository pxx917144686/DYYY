//
//  DYYYFLEXHierarchyTableViewCell.m
//  Flipboard
//
...
@interface DYYYFLEXHierarchyTableViewCell ()
...
@implementation DYYYFLEXHierarchyTableViewCell
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        ...
        self.depthIndicatorView.backgroundColor = DYYYFLEXUtility.hierarchyIndentPatternColor;
        [self.contentView addSubview:self.depthIndicatorView];
        
        UIImage *defaultCircleImage = [DYYYFLEXUtility circularImageWithColor:UIColor.blackColor radius:5];
        ...
        dispatch_once(&once, ^{
            checkerPatternColor = [UIColor colorWithPatternImage:DYYYFLEXResources.checkerPattern];
        });
        
        self.backgroundColorCheckerPatternView = [UIView new];
        self.backgroundColorCheckerPatternView.clipsToBounds = YES;
        self.backgroundColorCheckerPatternView.layer.borderColor = DYYYFLEXColor.tertiaryBackgroundColor.CGColor;
...
- (void)setRandomColorTag:(UIColor *)randomColorTag {
    if (![_randomColorTag isEqual:randomColorTag]) {
        ...
        self.colorCircleImageView.image = [DYYYFLEXUtility circularImageWithColor:randomColorTag radius:6];
    }
}
