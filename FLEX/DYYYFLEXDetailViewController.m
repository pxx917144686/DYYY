#import "DYYYFLEXDetailViewController.h"
#import "DYYYFLEXTableView.h"

@interface DYYYFLEXDetailViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSArray *keys;
@end

@implementation DYYYFLEXDetailViewController
