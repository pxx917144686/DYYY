#import "DYYYFLEXRuntimeHeaderViewController.h"
#import <objc/runtime.h>

@interface DYYYFLEXRuntimeHeaderViewController () <UITextViewDelegate>
@property (nonatomic, strong) UITextView *textView;
@end

@implementation DYYYFLEXRuntimeHeaderViewController

+ (instancetype)withClass:(Class)cls {
    DYYYFLEXRuntimeHeaderViewController *controller = [self new];
...
- (NSString *)generateHeaderForClass:(Class)cls {
    // 实现从 DYYYFLEXMachOClassBrowserViewController 复制
