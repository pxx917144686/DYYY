...
/// 接受给定令牌的运行时查询。
@interface DYYYFLEXRuntimeClient : NSObject

@property (nonatomic, readonly, class) DYYYFLEXRuntimeClient *runtime;
...
/// @return 类名
- (NSMutableArray<NSString *> *)classesForToken:(DYYYFLEXSearchToken *)token
