...
@implementation DYYYFLEXProperty
...
- (id)initWithProperty:(objc_property_t)property onClass:(Class)cls {
    ...
    if (self) {
        ...
        _attributes    = [DYYYFLEXPropertyAttributes attributesForProperty:property];
...
- (id)initWithName:(NSString *)name attributes:(DYYYFLEXPropertyAttributes *)attributes {
...
- (NSString *)description {
    if (!_flex_description) {
        NSString *readableType = [DYYYFLEXRuntimeUtility readableTypeForEncoding:self.attributes.typeEncoding];
        _flex_description = [DYYYFLEXRuntimeUtility appendName:self.name toType:readableType];
    }
...
- (NSString *)fullDescription {
    ...
    DYYYFLEXPropertyAttributes *attributes = self.attributes;
...
- (id)getValue:(id)target {
    ...
    if (self.likelyGetterExists) {
        ...
        if (instanceAndInstanceProperty || classAndClassProperty) {
            return [DYYYFLEXRuntimeUtility performSelector:self.likelyGetter onObject:target];
        }
    }
...
- (DYYYFLEXMethodBase *)getterWithImplementation:(IMP)implementation {
    ...
    DYYYFLEXMethodBase *getter = [DYYYFLEXMethodBase buildMethodNamed:name withTypes:types implementation:implementation];
    return getter;
}
...
- (DYYYFLEXMethodBase *)setterWithImplementation:(IMP)implementation {
    ...
    DYYYFLEXMethodBase *setter = [DYYYFLEXMethodBase buildMethodNamed:name withTypes:types implementation:implementation];
    return setter;
}
