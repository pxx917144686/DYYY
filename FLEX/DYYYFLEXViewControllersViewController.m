//
//  DYYYFLEXViewControllersViewController.m
//  FLEX
//
...
@interface DYYYFLEXViewControllersViewController ()
@property (nonatomic, readonly) DYYYFLEXMutableListSection *section;
@property (nonatomic, readonly) NSArray<UIViewController *> *controllers;
@end

@implementation DYYYFLEXViewControllersViewController
...
- (id)initWithViews:(NSArray<UIView *> *)views {
    ...
    if (self) {
        _controllers = [views flex_mapped:^id(UIView *view, NSUInteger idx) {
            return [DYYYFLEXUtility viewControllerForView:view];
        }];
    }
...
- (NSArray<DYYYFLEXTableViewSection *> *)makeSections {
    _section = [DYYYFLEXMutableListSection list:self.controllers
    ...
    self.section.selectionHandler = ^(UIViewController *host, UIViewController *controller) {
        [host.navigationController pushViewController:
            [DYYYFLEXObjectExplorerFactory explorerViewControllerForObject:controller]
        animated:YES];
    };
