...
@interface DYYYFLEXLookinDisplayItem : NSObject
...
@property (nonatomic, strong) NSArray<DYYYFLEXLookinDisplayItem *> *children;

// 搜索和匹配
- (BOOL)isMatchedWithSearchString:(NSString *)string;

// 层次遍历
- (void)enumerateSelfAndAncestors:(void (^)(DYYYFLEXLookinDisplayItem *item, BOOL *stop))block;
- (void)enumerateSelfAndChildren:(void (^)(DYYYFLEXLookinDisplayItem *item))block;
