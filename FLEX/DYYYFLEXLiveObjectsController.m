//
//  DYYYFLEXLiveObjectsController.m
//  Flipboard
//
...
@interface DYYYFLEXLiveObjectsController ()
...
@implementation DYYYFLEXLiveObjectsController
...
+ (UIViewController *)globalsEntryViewController:(FLEXGlobalsRow)row {
    DYYYFLEXLiveObjectsController *liveObjectsViewController = [self new];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString *className = self.filteredClassNames[indexPath.row];
    UIViewController *instances = [DYYYFLEXObjectListViewController
