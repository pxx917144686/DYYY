...
@interface DYYYFLEXKeyboardToolbar ()
...
@implementation DYYYFLEXKeyboardToolbar
...
- (void)addButtons {
    ...
    for (DYYYFLEXKBToolbarButton *button in self.buttons) {
...
- (void)setButtons:(NSArray<DYYYFLEXKBToolbarButton *> *)buttons {
