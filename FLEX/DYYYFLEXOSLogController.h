...
/// 用于iOS 10及以上版本的日志控制器。
@interface DYYYFLEXOSLogController : NSObject <FLEXLogController>
...
/// 在启用持久化之前创建的消息。
@property (nonatomic) NSMutableArray<DYYYFLEXSystemLogMessage *> *messages;
