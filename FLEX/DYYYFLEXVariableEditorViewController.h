//
//  DYYYFLEXVariableEditorViewController.h
//  Flipboard
//
...
/// 你想要修改或传递给目标的数据。
/// 该操作可能是调用方法、设置实例变量等。
@interface DYYYFLEXVariableEditorViewController : UIViewController {
    @protected
    id _target;
    _Nullable id _data;
...
@property (nonatomic, readonly, nullable) DYYYFLEXArgumentInputView *firstInputView;

@property (nonatomic, readonly) DYYYFLEXFieldEditorView *fieldEditorView;
