...
@interface DYYYFLEXMutableListSection<__covariant ObjectType> : DYYYFLEXCollectionContentSection
...
/// A readwrite version of the same property in \c DYYYFLEXTableViewSection.h
///
