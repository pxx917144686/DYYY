...
#pragma mark DYYYFLEXPropertyAttributes

@interface DYYYFLEXPropertyAttributes ()
...
@implementation DYYYFLEXPropertyAttributes
...
- (id)copyWithZone:(NSZone *)zone {
    return [[DYYYFLEXPropertyAttributes class] attributesFromDictionary:self.dictionary];
}

- (id)mutableCopyWithZone:(NSZone *)zone {
    return [[DYYYFLEXMutablePropertyAttributes class] attributesFromDictionary:self.dictionary];
}
...
#pragma mark DYYYFLEXMutablePropertyAttributes

@interface DYYYFLEXMutablePropertyAttributes ()
...
@implementation DYYYFLEXMutablePropertyAttributes
