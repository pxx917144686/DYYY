//
//  DYYYFLEXCollectionContentSection.h
//  FLEX
//
...
@class DYYYFLEXCollectionContentSection, DYYYFLEXTableViewCell;
...
typedef id<NSObject, NSFastEnumeration /* FLEXCollection */>(^FLEXCollectionContentFuture)(__kindof DYYYFLEXCollectionContentSection *section);

#pragma mark Collection
/// A protocol that enables \c DYYYFLEXCollectionContentSection to operate on any arbitrary collection.
...
#pragma mark - DYYYFLEXCollectionContentSection
/// A custom section for viewing collection elements.
///
/// Tapping on a row pushes an object explorer for that element.
@interface DYYYFLEXCollectionContentSection<__covariant ObjectType> : DYYYFLEXTableViewSection <FLEXObjectInfoSection> {
    @protected
