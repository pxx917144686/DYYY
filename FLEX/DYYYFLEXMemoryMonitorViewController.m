...
@interface DYYYFLEXMemoryMonitorViewController ()
...
@implementation DYYYFLEXMemoryMonitorViewController
...
- (void)startMonitoring {
    [[DYYYFLEXPerformanceMonitor sharedInstance] startMemoryMonitoring];
...
- (void)stopMonitoring {
    ...
    [[DYYYFLEXPerformanceMonitor sharedInstance] stopMemoryMonitoring];
}
