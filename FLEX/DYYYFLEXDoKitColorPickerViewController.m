...
@interface DYYYFLEXDoKitColorPickerViewController ()
...
@implementation DYYYFLEXDoKitColorPickerViewController
...
- (void)stopColorPicker {
    [[DYYYFLEXDoKitVisualTools sharedInstance] stopColorPicker];
