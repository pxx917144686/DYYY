...
#import "DYYYFLEXMemoryAnalyzer+RuntimeBrowser.h"
#import "DYYYFLEXHookDetector+RuntimeBrowser.h"

@implementation DYYYFLEXSystemAnalyzerViewController (RuntimeBrowser)
...
- (NSDictionary *)getAdvancedSystemAnalysis {
    ...
    // 内存分析
    DYYYFLEXMemoryAnalyzer *memoryAnalyzer = [DYYYFLEXMemoryAnalyzer sharedAnalyzer];
    analysis[@"memory"] = [memoryAnalyzer getDetailedHeapSnapshot];
    
    // Hook 分析
    DYYYFLEXHookDetector *hookDetector = [DYYYFLEXHookDetector sharedDetector];
