...
@interface DYYYFLEXIvar () {
    NSString *_flex_description;
}
@end

@implementation DYYYFLEXIvar
...
- (NSString *)description {
    if (!_flex_description) {
        NSString *readableType = [DYYYFLEXRuntimeUtility readableTypeForEncoding:self.typeEncoding];
