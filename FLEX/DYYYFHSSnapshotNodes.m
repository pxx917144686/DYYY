...
@interface DYYYFHSSnapshotNodes ()
@property (nonatomic, nullable) SCNNode *highlight;
@property (nonatomic, nullable) SCNNode *dimming;
@end
@implementation DYYYFHSSnapshotNodes

+ (instancetype)snapshot:(DYYYFHSViewSnapshot *)snapshot depth:(NSInteger)depth {
    DYYYFHSSnapshotNodes *nodes = [self new];
