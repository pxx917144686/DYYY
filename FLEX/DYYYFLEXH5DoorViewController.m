//
//  DYYYFLEXH5DoorViewController.m
//  FLEX
//
//  Created for DoKit integration
//

#import "DYYYFLEXH5DoorViewController.h"
#import "DYYYFLEXAlert.h"

@interface DYYYFLEXH5DoorViewController () <UITextFieldDelegate>
...
@implementation DYYYFLEXH5DoorViewController
...
- (void)openURL:(NSString *)urlString {
    ...
    if (url) {
        ...
        [DYYYFLEXAlert showAlert:@"无效URL" message:@"请输入有效的URL地址" from:self];
    }
}
