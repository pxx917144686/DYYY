...
@interface DYYYFLEXExplorerToolbarItem : UIButton
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(nullable DYYYFLEXExplorerToolbarItem *)backupItem;
...
@property (nonatomic, readonly) DYYYFLEXExplorerToolbarItem *sibling;
...
@property (nonatomic, readonly) DYYYFLEXExplorerToolbarItem *currentItem;
