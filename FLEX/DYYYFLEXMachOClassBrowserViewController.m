...
@implementation DYYYFLEXMachOClassBrowserViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cls) {
        // 创建类浏览器
        UIViewController *classExplorer = [DYYYFLEXObjectExplorerFactory explorerViewControllerForObject:cls];
