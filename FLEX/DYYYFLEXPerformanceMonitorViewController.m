//
//  DYYYFLEXPerformanceMonitorViewController.m
//  FLEX
//
//  Created from RuntimeBrowser functionalities.
//

#import "DYYYFLEXPerformanceMonitorViewController.h"
#import "DYYYFLEXPerformanceMonitor.h"

@interface DYYYFLEXPerformanceMonitorViewController ()
@property (nonatomic, strong) NSArray *sections;
@property (nonatomic, strong) NSArray *sectionTitles;
@property (nonatomic, assign) BOOL isProfiling;
@end

@implementation DYYYFLEXPerformanceMonitorViewController
...
- (void)viewDidLoad {
    ...
    // 开始跟踪类加载时间
    [[DYYYFLEXPerformanceMonitor sharedInstance] startTrackingClassLoadTime];
}

- (void)toggleProfiling {
    if (self.isProfiling) {
        // 停止分析
        [[DYYYFLEXPerformanceMonitor sharedInstance] stopMethodProfiling];
        self.navigationItem.rightBarButtonItem.title = @"开始分析";
        
        // 获取结果
        NSArray *results = [[DYYYFLEXPerformanceMonitor sharedInstance] getProfilingResults];
        ...
        // 开始分析
        [[DYYYFLEXPerformanceMonitor sharedInstance] startMethodProfiling];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    // 更新类加载时间
    NSArray *classLoadTimes = [[DYYYFLEXPerformanceMonitor sharedInstance] getClassLoadTimeInfo];
