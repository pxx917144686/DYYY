//
//  DYYYFLEXVisualToolsViewController.m
//  FLEX
//
//  Copyright © 2023 FLEX Team. All rights reserved.
//

#import "DYYYFLEXVisualToolsViewController.h"
#import "DYYYFLEXColorPickerTool.h"
#import "DYYYFLEXRulerTool.h"

@interface DYYYFLEXVisualToolsViewController ()

@property (nonatomic, strong) NSArray *toolsList;

@end

@implementation DYYYFLEXVisualToolsViewController
    ...
    switch (indexPath.row) {
        case 0: // 颜色拾取器
            [self dismissViewControllerAnimated:YES completion:^{
                [[DYYYFLEXColorPickerTool sharedInstance] show];
            }];
            break;
            
        case 1: // 对齐标尺
            [self dismissViewControllerAnimated:YES completion:^{
                [[DYYYFLEXRulerTool sharedInstance] show];
            }];
            break;
