...
@interface DYYYFLEXNetworkWeakTester ()
...
@implementation DYYYFLEXNetworkWeakTester

+ (instancetype)sharedInstance {
    static DYYYFLEXNetworkWeakTester *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[DYYYFLEXNetworkWeakTester alloc] init];
    });
    return instance;
}
...
+ (NSURLSessionConfiguration *)flex_defaultSessionConfiguration {
    ...
    FLEXNetworkWeakType weakType = [DYYYFLEXNetworkWeakTester sharedInstance].currentWeakType;
