//
//  DYYYFLEXMemoryAnalyzerViewController.m
//  FLEX
//
//  Created from RuntimeBrowser functionalities.
//

#import "DYYYFLEXMemoryAnalyzerViewController.h"
#import "DYYYFLEXMemoryAnalyzer.h"

@interface DYYYFLEXMemoryAnalyzerViewController ()
@property (nonatomic, strong) NSDictionary *memoryUsage;
@property (nonatomic, strong) NSArray *classes;
@end

@implementation DYYYFLEXMemoryAnalyzerViewController
...
- (void)refreshMemoryData {
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        DYYYFLEXMemoryAnalyzer *analyzer = [DYYYFLEXMemoryAnalyzer sharedAnalyzer];
