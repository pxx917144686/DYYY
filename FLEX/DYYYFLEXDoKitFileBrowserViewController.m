...
@interface DYYYFLEXDoKitFileBrowserViewController ()
@property (nonatomic, strong) NSArray *directoryContents;
@property (nonatomic, strong) NSString *currentPath;
@end

@implementation DYYYFLEXDoKitFileBrowserViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (isDirectory) {
        // 进入子目录
        DYYYFLEXDoKitFileBrowserViewController *subDirVC = [[DYYYFLEXDoKitFileBrowserViewController alloc] init];
