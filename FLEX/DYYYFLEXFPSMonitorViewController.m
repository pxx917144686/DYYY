...
@interface DYYYFLEXFPSMonitorViewController ()
...
@implementation DYYYFLEXFPSMonitorViewController
...
- (void)startMonitoring {
    [[DYYYFLEXPerformanceMonitor sharedInstance] startFPSMonitoring];
...
- (void)stopMonitoring {
    ...
    [[DYYYFLEXPerformanceMonitor sharedInstance] stopFPSMonitoring];
}
...
- (void)updateFPS {
    ...
    // ✅ 修复：使用正确的属性访问方式
    CGFloat fps = [[DYYYFLEXPerformanceMonitor sharedInstance] currentFPS];
