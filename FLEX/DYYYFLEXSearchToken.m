...
@interface DYYYFLEXSearchToken () {
    NSString *flex_description;
}
@end

@implementation DYYYFLEXSearchToken

+ (instancetype)any {
    static DYYYFLEXSearchToken *any = nil;
...
+ (instancetype)string:(NSString *)string options:(TBWildcardOptions)options {
    DYYYFLEXSearchToken *token  = [self new];
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[DYYYFLEXSearchToken class]]) {
        DYYYFLEXSearchToken *token = object;
