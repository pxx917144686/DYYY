...
@interface DYYYFLEXLookinMeasureViewController ()
@property (nonatomic, strong) UISwitch *measureSwitch;
@property (nonatomic, strong) UILabel *instructionLabel;
@end

@implementation DYYYFLEXLookinMeasureViewController
...
- (void)measureSwitchChanged:(UISwitch *)sender {
    DYYYFLEXLookinMeasureController *controller = [DYYYFLEXLookinMeasureController sharedInstance];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if (self.measureSwitch.isOn) {
        [[DYYYFLEXLookinMeasureController sharedInstance] stopMeasuring];
    }
}
