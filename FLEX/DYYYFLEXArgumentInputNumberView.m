//
//  DYYYFLEXArgumentInputNumberView.m
//  Flipboard
//
...
@implementation DYYYFLEXArgumentInputNumberView
...
- (id)inputValue {
    return [DYYYFLEXRuntimeUtility valueForNumberWithObjCType:self.typeEncoding.UTF8String fromInputString:self.inputTextView.text];
}
