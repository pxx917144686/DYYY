...
@interface DYYYFLEXManager : NSObject

@property (nonatomic, readonly, class) DYYYFLEXManager *sharedManager;

@property (nonatomic, readonly) BOOL isHidden;
@property (nonatomic, readonly) DYYYFLEXExplorerToolbar *toolbar;
