//
//  DYYYFLEXWindowManagerController.m
//  FLEX
//
//  由 Tanner 创建于 2/6/20.
...
@interface DYYYFLEXWindowManagerController ()
...
@implementation DYYYFLEXWindowManagerController
...
- (void)showRevertOrDismissAlert:(void(^)(void))revertBlock {
    ...
    } showFrom:[DYYYFLEXUtility topViewControllerInWindow:highestWindow]];
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    UIWindow *window = nil;
    NSString *subtitle = nil;
    DYYYFLEXWindow *flex = DYYYFLEXManager.sharedManager.explorerWindow;
...
- (void)tableView:(UITableView *)tableView accessoryButtonTappedForRowWithIndexPath:(NSIndexPath *)ip {
    [self.navigationController pushViewController:
        [DYYYFLEXObjectExplorerFactory explorerViewControllerForObject:self.sections[ip.section][ip.row]]
    animated:YES];
}
