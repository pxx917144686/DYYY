//
//  DYYYFLEXFilteringTableViewController.h
//  FLEX
//
...
@property (nonatomic, copy) NSArray<DYYYFLEXTableViewSection *> *sections;
...
@property (nonatomic, copy) NSArray<DYYYFLEXTableViewSection *> *allSections;

/// This computed property should filter \c allSections for assignment to \c sections
@property (nonatomic, readonly, copy) NSArray<DYYYFLEXTableViewSection *> *nonemptySections;
...
#pragma mark - DYYYFLEXFilteringTableViewController
/// A table view which implements \c UITableView* methods using arrays of
/// \c DYYYFLEXTableViewSection objects provied by a special delegate.
@interface DYYYFLEXFilteringTableViewController : DYYYFLEXTableViewController <FLEXTableViewFiltering>
