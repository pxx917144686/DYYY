...
NSString * const kFLEXDefaultsNetworkObserverEnabledKey = @"com.flex.DYYYFLEXNetworkObserver.enableOnLaunch";
NSString * const kFLEXDefaultsNetworkObserverLastModeKey = @"com.flex.DYYYFLEXNetworkObserver.lastMode";
