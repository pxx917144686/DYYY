...
@interface DYYYFLEXTableViewController ()
...
@implementation DYYYFLEXTableViewController
@dynamic tableView;
...
- (void)setShowsCarousel:(BOOL)showsCarousel {
    ...
    if (showsCarousel) {
        _carousel = ({ weakify(self)
            ...
            DYYYFLEXScopeCarousel *carousel = [DYYYFLEXScopeCarousel new];
            ...
            [carousel registerBlockForDynamicTypeChanges:^(DYYYFLEXScopeCarousel *_) { strongify(self);
...
- (void)loadView {
    self.view = [DYYYFLEXTableView style:self.style];
    ...
    _bookmarksToolbarItem = [UIBarButtonItem
        flex_itemWithImage:DYYYFLEXResources.bookmarksIcon target:self action:@selector(showBookmarks)
    ];
    _openTabsToolbarItem = [UIBarButtonItem
        flex_itemWithImage:DYYYFLEXResources.openTabsIcon target:self action:@selector(showTabSwitcher)
    ];
...
- (void)setupToolbarItems {
    ...
    if (![presenter isKindOfClass:[DYYYFLEXExplorerViewController class]]) {
...
- (void)addCarousel:(DYYYFLEXScopeCarousel *)carousel {
    if (@available(iOS 11.0, *)) {
...
- (void)removeCarousel:(DYYYFLEXScopeCarousel *)carousel {
...
- (void)showBookmarks {
    UINavigationController *nav = [[UINavigationController alloc]
        initWithRootViewController:[DYYYFLEXBookmarksViewController new]
    ];
