//
//  DYYYFLEXArgumentInputColorView.m
//  Flipboard
//
...
@interface DYYYFLEXColorComponentInputView : UIView
...
- (void)colorComponentInputViewValueDidChange:(DYYYFLEXColorComponentInputView *)colorComponentInputView;

@end


@implementation DYYYFLEXColorComponentInputView
...
@interface DYYYFLEXColorPreviewBox : UIView
...
@implementation DYYYFLEXColorPreviewBox
...
@interface DYYYFLEXArgumentInputColorView () <FLEXColorComponentInputViewDelegate>

@property (nonatomic) DYYYFLEXColorPreviewBox *colorPreviewBox;
@property (nonatomic) UILabel *hexLabel;
@property (nonatomic) DYYYFLEXColorComponentInputView *alphaInput;
@property (nonatomic) DYYYFLEXColorComponentInputView *redInput;
@property (nonatomic) DYYYFLEXColorComponentInputView *greenInput;
@property (nonatomic) DYYYFLEXColorComponentInputView *blueInput;

@end

@implementation DYYYFLEXArgumentInputColorView

- (instancetype)initWithArgumentTypeEncoding:(const char *)typeEncoding {
    self = [super initWithArgumentTypeEncoding:typeEncoding];
    if (self) {
        self.colorPreviewBox = [DYYYFLEXColorPreviewBox new];
        ...
        self.alphaInput = [DYYYFLEXColorComponentInputView new];
        ...
        self.blueInput = [DYYYFLEXColorComponentInputView new];
...
- (void)layoutSubviews {
    ...
    NSArray<DYYYFLEXColorComponentInputView *> *colorComponentInputViews = @[self.alphaInput, self.redInput, self.greenInput, self.blueInput];
    for (DYYYFLEXColorComponentInputView *inputView in colorComponentInputViews) {
