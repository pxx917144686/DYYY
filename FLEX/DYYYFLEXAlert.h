...
@class DYYYFLEXAlert, DYYYFLEXAlertAction;

typedef void (^FLEXAlertReveal)(void);
typedef void (^FLEXAlertBuilder)(DYYYFLEXAlert *make);
typedef DYYYFLEXAlert * _Nonnull (^FLEXAlertStringProperty)(NSString * _Nullable);
typedef DYYYFLEXAlert * _Nonnull (^FLEXAlertStringArg)(NSString * _Nullable);
typedef DYYYFLEXAlert * _Nonnull (^FLEXAlertTextField)(void(^configurationHandler)(UITextField *textField));
typedef DYYYFLEXAlertAction * _Nonnull (^FLEXAlertAddAction)(NSString *title);
typedef DYYYFLEXAlertAction * _Nonnull (^FLEXAlertActionStringProperty)(NSString * _Nullable);
typedef DYYYFLEXAlertAction * _Nonnull (^FLEXAlertActionProperty)(void);
typedef DYYYFLEXAlertAction * _Nonnull (^FLEXAlertActionBOOLProperty)(BOOL);
typedef DYYYFLEXAlertAction * _Nonnull (^FLEXAlertActionHandler)(void(^handler)(NSArray<NSString *> *strings));

@interface DYYYFLEXAlert : NSObject
...
@interface DYYYFLEXAlertAction : NSObject
