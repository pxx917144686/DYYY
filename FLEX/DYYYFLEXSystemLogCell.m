...
@interface DYYYFLEXSystemLogCell ()
...
@implementation DYYYFLEXSystemLogCell
...
- (void)setLogMessage:(DYYYFLEXSystemLogMessage *)logMessage {
...
+ (NSAttributedString *)attributedTextForLogMessage:(DYYYFLEXSystemLogMessage *)logMessage highlightedText:(NSString *)highlightedText {
