...
@interface DYYYFLEXScopeCarousel () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, readonly) UICollectionView *collectionView;
@property (nonatomic, readonly) DYYYFLEXCarouselCell *sizingCell;
...
@implementation DYYYFLEXScopeCarousel

- (id)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.backgroundColor = DYYYFLEXColor.primaryBackgroundColor;
        ...
        _collectionView = ({
            ...
            cv.delegate = self;
            cv.dataSource = self;
            [cv registerClass:[DYYYFLEXCarouselCell class] forCellWithReuseIdentifier:kCarouselCellReuseIdentifier];
        ...
        // 尺寸单元格
        _sizingCell = [DYYYFLEXCarouselCell new];
        ...
        _dynamicTypeObserver = [NSNotificationCenter.defaultCenter
            ...
            object:nil queue:nil usingBlock:^(NSNotification *note) { strongify(self)
                ...
                // 通知观察者
                for (void (^block)(DYYYFLEXScopeCarousel *) in self.dynamicTypeHandlers) {
                    block(self);
                }
            }
        ];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextSetStrokeColorWithColor(context, DYYYFLEXColor.hairlineColor.CGColor);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView
    ...
    DYYYFLEXCarouselCell *cell = (id)[collectionView dequeueReusableCellWithReuseIdentifier:kCarouselCellReuseIdentifier
