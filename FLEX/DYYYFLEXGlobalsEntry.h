...
@protocol DYYYFLEXGlobalsEntry <NSObject>
...
@interface DYYYFLEXGlobalsEntry : NSObject
...
+ (instancetype)entryWithEntry:(Class<DYYYFLEXGlobalsEntry>)entry row:(FLEXGlobalsRow)row;
...
@interface NSObject (DYYYFLEXGlobalsEntry)

/// @return The result of passing self to +[DYYYFLEXGlobalsEntry entryWithEntry:]
/// if the class conforms to DYYYFLEXGlobalsEntry, else, nil.
+ (nullable DYYYFLEXGlobalsEntry *)flex_concreteGlobalsEntry:(FLEXGlobalsRow)row;
