...
@implementation DYYYUCDecryptTool
...
+ (void)installDecryptHooksIfNeeded {
    ...
    dispatch_once(&onceToken, ^{
        @autoreleasepool {
            [[DYYYDatabaseManager sharedManager] createTables];
            [[DYYYDatabaseManager sharedManager] insertLogText:[NSString stringWithFormat:@"Decrypt feature loaded for %@", CurrentBundleID()]];
            RegisterCryptoHooks();
