#import "DYYYUCFilzaTool.h"
#import "../Shared/DYYYUCAppGroupHelper.h"
...
static BOOL UCFilzaSaveAssetOverrideFromURL(NSString *carPath, NSString *assetName, NSURL *sourceURL, NSError **error) {
    ...
    if (!saved) {
        if (error && *error == nil) {
            *error = [NSError errorWithDomain:@"DYYYUCFilzaTool"
                                         code:2001
...
@interface DYYYUCFilzaEditorViewController : UIViewController

- (instancetype)initWithFilePath:(NSString *)filePath;

@end

@interface DYYYUCFilzaQuickLookPreviewController : QLPreviewController <QLPreviewControllerDataSource>

- (instancetype)initWithFilePath:(NSString *)filePath;

@end

@interface DYYYUCFilzaCarManagerViewController : UIViewController <UIDocumentPickerDelegate>

- (instancetype)initWithFilePath:(NSString *)filePath;

@end

@interface DYYYUCFilzaCarAssetListViewController : UITableViewController <UISearchResultsUpdating>

- (instancetype)initWithFilePath:(NSString *)filePath;

@end

@interface DYYYUCFilzaCarAssetGridCell : UICollectionViewCell

- (void)configureWithTitle:(NSString *)title subtitle:(NSString *)subtitle image:(UIImage *)image highlighted:(BOOL)highlighted;

@end

@interface DYYYUCFilzaCarAssetGridViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchResultsUpdating>

- (instancetype)initWithFilePath:(NSString *)filePath;

@end

@interface DYYYUCFilzaCarAssetDetailViewController : UIViewController <UIDocumentPickerDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate>

- (instancetype)initWithFilePath:(NSString *)filePath assetName:(NSString *)assetName;

@end

@interface DYYYUCFilzaZipEntry : NSObject
...
@interface DYYYUCFilzaZipArchive : NSObject

@property (nonatomic, copy, readonly) NSString *filePath;
@property (nonatomic, copy, readonly) NSArray<DYYYUCFilzaZipEntry *> *entries;

- (instancetype)initWithFilePath:(NSString *)filePath error:(NSError **)error;
- (NSArray<DYYYUCFilzaZipEntry *> *)entriesForPrefix:(NSString *)prefix;
- (NSData *)dataForEntry:(DYYYUCFilzaZipEntry *)entry error:(NSError **)error;
- (NSString *)temporaryPathForEntry:(DYYYUCFilzaZipEntry *)entry error:(NSError **)error;
- (NSString *)extractEntriesWithPrefix:(NSString *)prefix error:(NSError **)error;

@end

@interface DYYYUCFilzaZipBrowserViewController : UITableViewController <UISearchResultsUpdating>

- (instancetype)initWithZipPath:(NSString *)zipPath title:(NSString *)title prefix:(NSString *)prefix archive:(DYYYUCFilzaZipArchive *)archive;

@end

@interface DYYYUCFilzaBrowserViewController : UITableViewController <UISearchResultsUpdating>

- (instancetype)initWithDirectoryPath:(NSString *)directoryPath title:(NSString *)title;

@end

@interface DYYYUCFilzaAppInfoViewController : UITableViewController
@end

@interface DYYYUCFilzaRootViewController : UITableViewController
@end

@interface DYYYUCFilzaRootViewController ()
...
static UIViewController *UCFilzaViewControllerForPath(NSString *path, NSString *titleOverride) {
    ...
    if (UCFilzaPathIsDirectory(normalizedPath)) {
        return [[DYYYUCFilzaBrowserViewController alloc] initWithDirectoryPath:normalizedPath title:titleOverride ?: normalizedPath.lastPathComponent];
    }
    if (UCFilzaIsAssetsCarPath(normalizedPath)) {
        return [[DYYYUCFilzaCarManagerViewController alloc] initWithFilePath:normalizedPath];
    }
    if (UCFilzaIsSQLitePath(normalizedPath)) {
        return [[DYYYFLEXTableListViewController alloc] initWithPath:normalizedPath];
    }
    if (UCFilzaIsZIPPath(normalizedPath)) {
        return [[DYYYUCFilzaZipBrowserViewController alloc] initWithZipPath:normalizedPath title:titleOverride ?: normalizedPath.lastPathComponent prefix:@"" archive:nil];
    }
    if (UCFilzaShouldUseQuickLookPreview(normalizedPath)) {
        return [[DYYYUCFilzaQuickLookPreviewController alloc] initWithFilePath:normalizedPath];
    }
    return [[DYYYUCFilzaEditorViewController alloc] initWithFilePath:normalizedPath];
}
...
@implementation DYYYUCFilzaRootViewController
...
- (void)viewDidLoad {
    ...
    self.appGroupEntries = [DYYYUCAppGroupHelper accessibleAppGroups] ?: @[];
...
- (void)showAppInfo {
    DYYYUCFilzaAppInfoViewController *appInfoVC = [[DYYYUCFilzaAppInfoViewController alloc] initWithStyle:UITableViewStyleInsetGrouped];
...
@interface DYYYUCFilzaListViewController : UITableViewController
...
@implementation DYYYUCFilzaListViewController

+ (instancetype)controllerWithTitle:(NSString *)title items:(NSArray<NSDictionary<NSString *, NSString *> *> *)items {
    DYYYUCFilzaListViewController *vc = [[DYYYUCFilzaListViewController alloc] initWithStyle:UITableViewStyleInsetGrouped];
    vc.listTitle = title;
    vc.items = items ?: @[];
    return vc;
}
...
@interface DYYYUCFilzaAppInfoViewController ()
...
@implementation DYYYUCFilzaAppInfoViewController
...
- (void)loadAppGroups {
    NSArray<NSDictionary *> *groups = [DYYYUCAppGroupHelper accessibleAppGroups] ?: @[];
...
- (void)showDylibsList {
    ...
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"加载动态库" items:dylibs];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showLoadCommands {
    NSArray *cmds = UCFilzaMachOLoadCommands();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"Load Commands" items:cmds];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showSegments {
    NSArray *segs = UCFilzaMachOSegments();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"Segments" items:segs];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showEnvironmentList {
    NSArray *env = UCFilzaEnvironmentList();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"环境变量" items:env];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showArgumentsList {
    NSArray *args = UCFilzaArgumentsList();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"启动参数" items:args];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showURLSchemesList {
    NSArray *schemes = UCFilzaURLSchemesList();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"URL Schemes" items:schemes];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showBackgroundModes {
    NSArray *modes = UCFilzaBackgroundModes();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"后台模式" items:modes];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showInfoPlistKeys {
    NSArray *keys = UCFilzaInfoPlistKeys();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"Info.plist" items:keys];
    [self.navigationController pushViewController:vc animated:YES];
}
...
- (void)showUserDefaults {
    ...
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"UserDefaults" items:items];
    [self.navigationController pushViewController:vc animated:YES];
}

- (void)showCookies {
    NSArray *cookies = UCFilzaCookieList();
    DYYYUCFilzaListViewController *vc = [DYYYUCFilzaListViewController controllerWithTitle:@"Cookies" items:cookies];
    [self.navigationController pushViewController:vc animated:YES];
}
...
@interface DYYYUCFilzaBrowserViewController ()
...
@implementation DYYYUCFilzaBrowserViewController
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"创建" style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
        ...
        if (isDirectory) {
            ...
            if (![NSFileManager.defaultManager fileExistsAtPath:targetPath]) {
                createError = [NSError errorWithDomain:@"DYYYUCFilzaTool"
                                                  code:1003
...
@interface DYYYUCFilzaQuickLookPreviewController ()

@property (nonatomic, copy) NSString *filePath;

@end

@implementation DYYYUCFilzaQuickLookPreviewController
...
- (void)editTapped {
    DYYYUCFilzaEditorViewController *editor = [[DYYYUCFilzaEditorViewController alloc] initWithFilePath:self.filePath];
...
@implementation DYYYUCFilzaZipEntry
@end

@interface DYYYUCFilzaZipArchive ()

@property (nonatomic, copy, readwrite) NSString *filePath;
@property (nonatomic, copy, readwrite) NSArray<DYYYUCFilzaZipEntry *> *entries;
@property (nonatomic, strong) NSData *mappedData;

@end

@implementation DYYYUCFilzaZipArchive
...
- (instancetype)initWithFilePath:(NSString *)filePath error:(NSError **)error {
    ...
    NSMutableArray<DYYYUCFilzaZipEntry *> *entries = [NSMutableArray arrayWithCapacity:totalEntries];
    ...
    for (uint16_t idx = 0; idx < totalEntries; idx++) {
        ...
        if (sanitizedPath.length) {
            ...
            DYYYUCFilzaZipEntry *entry = [DYYYUCFilzaZipEntry new];
    ...
    [entries sortUsingComparator:^NSComparisonResult(DYYYUCFilzaZipEntry *lhs, DYYYUCFilzaZipEntry *rhs) {
...
- (NSArray<DYYYUCFilzaZipEntry *> *)entriesForPrefix:(NSString *)prefix {
    ...
    NSMutableArray<DYYYUCFilzaZipEntry *> *matches = [NSMutableArray array];
    for (DYYYUCFilzaZipEntry *entry in self.entries) {
...
- (NSData *)compressedDataForEntry:(DYYYUCFilzaZipEntry *)entry error:(NSError **)error {
...
- (NSString *)extractEntriesWithPrefix:(NSString *)prefix error:(NSError **)error {
    ...
    NSArray<DYYYUCFilzaZipEntry *> *candidates = [self entriesForPrefix:normalizedPrefix];
    for (DYYYUCFilzaZipEntry *entry in candidates) {
...
@interface DYYYUCFilzaZipBrowserViewController ()

@property (nonatomic, copy) NSString *zipPath;
@property (nonatomic, copy) NSString *displayTitle;
@property (nonatomic, copy) NSString *currentPrefix;
@property (nonatomic, strong) DYYYUCFilzaZipArchive *archive;
...
@implementation DYYYUCFilzaZipBrowserViewController
...
- (void)loadArchiveOrRefresh {
    ...
    dispatch_async(dispatch_get_global_queue(QOS_CLASS_USER_INITIATED, 0), ^{
        NSError *error = nil;
        DYYYUCFilzaZipArchive *archive = [[DYYYUCFilzaZipArchive alloc] initWithFilePath:self.zipPath error:&error];
        dispatch_async(dispatch_get_main_queue(), ^{
            __strong typeof(weakSelf) self = weakSelf;
            if (!self) return;
            [self.refreshControl endRefreshing];
...
- (void)rebuildItems {
    ...
    for (DYYYUCFilzaZipEntry *entry in [self.archive entriesForPrefix:prefixWithSlash]) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (isDirectory) {
        ...
        DYYYUCFilzaZipEntry *entry = item[@"entry"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([item[@"type"] isEqualToString:@"dir"]) {
        ...
        DYYYUCFilzaZipBrowserViewController *browser = [[DYYYUCFilzaZipBrowserViewController alloc] initWithZipPath:self.zipPath title:title prefix:prefix archive:self.archive];
...
@implementation DYYYUCFilzaCarAssetGridCell {
...
@interface DYYYUCFilzaCarAssetGridViewController () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UISearchResultsUpdating, UICollectionViewDataSourcePrefetching>
...
@implementation DYYYUCFilzaCarAssetGridViewController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:DYYYUCFilzaCarAssetGridCell.class forCellWithReuseIdentifier:@"assetGridCell"];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    DYYYUCFilzaCarAssetGridCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"assetGridCell" forIndexPath:indexPath];
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    for (NSIndexPath *indexPath in self.collectionView.indexPathsForVisibleItems) {
        ...
        DYYYUCFilzaCarAssetGridCell *cell = (DYYYUCFilzaCarAssetGridCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
        if (cell) {
            NSString *subtitle = overridden ? @"已替换" : @"原图";
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    NSString *assetName = self.visibleAssetNames[indexPath.item];
    DYYYUCFilzaCarAssetDetailViewController *detail = [[DYYYUCFilzaCarAssetDetailViewController alloc] initWithFilePath:self.filePath assetName:assetName];
    [self.navigationController pushViewController:detail animated:YES];
}

@end

@interface DYYYUCFilzaCarAssetListViewController ()
...
@implementation DYYYUCFilzaCarAssetListViewController
...
- (void)openGridTapped {
    DYYYUCFilzaCarAssetGridViewController *controller = [[DYYYUCFilzaCarAssetGridViewController alloc] initWithFilePath:self.filePath];
    [self.navigationController pushViewController:controller animated:YES];
}
...
@interface DYYYUCFilzaCarAssetDetailViewController ()
...
@implementation DYYYUCFilzaCarAssetDetailViewController
...
@interface DYYYUCFilzaCarManagerViewController ()
...
@implementation DYYYUCFilzaCarManagerViewController
...
- (void)browseAssetsTapped {
    DYYYUCFilzaCarAssetListViewController *controller = [[DYYYUCFilzaCarAssetListViewController alloc] initWithFilePath:self.filePath];
    [self.navigationController pushViewController:controller animated:YES];
}
...
@interface DYYYUCFilzaEditorViewController ()
...
@implementation DYYYUCFilzaEditorViewController
...
- (void)showMoreActions:(UIBarButtonItem *)sender {
    ...
    if (UCFilzaIsAssetsCarPath(self.filePath)) {
        ...
        [sheet addAction:[UIAlertAction actionWithTitle:@"打开 assets.car 导入页" style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
            DYYYUCFilzaCarManagerViewController *manager = [[DYYYUCFilzaCarManagerViewController alloc] initWithFilePath:self.filePath];
    ...
    if (UCFilzaIsSQLitePath(self.filePath)) {
        [sheet addAction:[UIAlertAction actionWithTitle:@"打开 SQLite 查看器" style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
            DYYYFLEXTableListViewController *controller = [[DYYYFLEXTableListViewController alloc] initWithPath:self.filePath];
            [self.navigationController pushViewController:controller animated:YES];
        }]];
    }
    if (UCFilzaIsZIPPath(self.filePath)) {
        [sheet addAction:[UIAlertAction actionWithTitle:@"打开 ZIP 浏览器" style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
            DYYYUCFilzaZipBrowserViewController *controller = [[DYYYUCFilzaZipBrowserViewController alloc] initWithZipPath:self.filePath title:self.filePath.lastPathComponent prefix:@"" archive:nil];
            [self.navigationController pushViewController:controller animated:YES];
        }]];
    }
    [sheet addAction:[UIAlertAction actionWithTitle:@"分享文件" style:UIAlertActionStyleDefault handler:^(__unused UIAlertAction *action) {
...
@implementation DYYYUCFilzaTool
...
+ (void)presentFilzaPanelFromViewController:(UIViewController *)viewController {
    ...
    DYYYUCFilzaAppInfoViewController *root = [[DYYYUCFilzaAppInfoViewController alloc] initWithStyle:UITableViewStyleInsetGrouped];
