...
@class DYYYUCDisasmInstruction;
@class DYYYUCBasicBlock;
@class DYYYUCFunction;

@interface DYYYUCDisasmOperand : NSObject
...
@interface DYYYUCDisasmInstruction : NSObject
...
@property (nonatomic, strong) NSArray<DYYYUCDisasmOperand *> *operandList;
...
@property (nonatomic, weak, nullable) DYYYUCBasicBlock *basicBlock;
@end

@interface DYYYUCDisasmResult : NSObject
@property (nonatomic, assign) uint64_t startAddress;
@property (nonatomic, assign) NSUInteger instructionCount;
@property (nonatomic, strong) NSArray<DYYYUCDisasmInstruction *> *instructions;
@property (nonatomic, copy) NSString *engineName;
@property (nonatomic, strong, nullable) NSArray<DYYYUCFunction *> *functions;
@property (nonatomic, strong, nullable) NSDictionary<NSNumber *, DYYYUCDisasmInstruction *> *addressMap;
@end

@interface DYYYUCBasicBlock : NSObject
@property (nonatomic, assign) uint64_t startAddress;
@property (nonatomic, assign) uint64_t endAddress;
@property (nonatomic, assign) NSUInteger instructionCount;
@property (nonatomic, strong) NSArray<DYYYUCDisasmInstruction *> *instructions;
@property (nonatomic, assign) UCBasicBlockType type;
@property (nonatomic, strong, nullable) NSMutableArray<DYYYUCBasicBlock *> *successors;
@property (nonatomic, strong, nullable) NSMutableArray<DYYYUCBasicBlock *> *predecessors;
@property (nonatomic, weak, nullable) DYYYUCFunction *function;
@property (nonatomic, assign) NSInteger blockId;
@property (nonatomic, assign) CGPoint layoutPosition;
@property (nonatomic, assign) CGSize layoutSize;
@end

@interface DYYYUCFunction : NSObject
@property (nonatomic, assign) uint64_t startAddress;
@property (nonatomic, assign) uint64_t endAddress;
@property (nonatomic, assign) NSUInteger size;
...
@property (nonatomic, strong) NSArray<DYYYUCDisasmInstruction *> *instructions;
@property (nonatomic, strong) NSArray<DYYYUCBasicBlock *> *basicBlocks;
...
@interface DYYYUCSymbolInfo : NSObject
@property (nonatomic, assign) uint64_t address;
@property (nonatomic, copy) NSString *name;
...
@interface DYYYUCDisassembler : NSObject
...
- (nullable DYYYUCDisasmResult *)disassembleAtAddress:(uint64_t)address
                                             size:(NSUInteger)size;

- (nullable DYYYUCDisasmResult *)disassembleMethod:(Method)method;

- (nullable DYYYUCDisasmResult *)disassembleClass:(Class)cls
                                     selector:(SEL)selector
                                isClassMethod:(BOOL)isClassMethod;

- (nullable DYYYUCFunction *)analyzeFunctionAtAddress:(uint64_t)address
                                        maxSize:(NSUInteger)maxSize;

- (nullable NSArray<DYYYUCBasicBlock *> *)buildCFG:(NSArray<DYYYUCDisasmInstruction *> *)instructions;

- (nullable NSArray<DYYYUCFunction *> *)scanFunctionsInRange:(uint64_t)start
                                                    size:(NSUInteger)size;

+ (nullable NSString *)symbolNameAtAddress:(uint64_t)address;

+ (nullable DYYYUCSymbolInfo *)symbolInfoAtAddress:(uint64_t)address;
