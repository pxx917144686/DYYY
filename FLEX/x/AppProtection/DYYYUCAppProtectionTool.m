#import "DYYYUCAppProtectionTool.h"
...
@class DYYYUCAppProtectionSettingsViewController;
@class DYYYUCAppProtectionBiometricViewController;
@class DYYYUCAppProtectionCalculatorViewController;
...
@interface DYYYUCAppProtectionTool ()
...
@interface DYYYUCAppProtectionSettingsViewController : UIViewController
...
@interface DYYYUCAppProtectionBiometricViewController : UIViewController
...
@interface DYYYUCAppProtectionCalculatorViewController : UIViewController
...
@implementation DYYYUCAppProtectionTool
...
+ (void)presentProtectionPanelFromViewController:(UIViewController *)viewController
    ...
    dispatch_async(dispatch_get_main_queue(), ^{
        ...
        DYYYUCAppProtectionSettingsViewController *settings = [DYYYUCAppProtectionSettingsViewController new];
        settings.completion = ^{
            UCAppProtectionShowingSettings = NO;
...
+ (void)showLockWindowForActiveUnlock:(BOOL)activeUnlock {
    ...
    if (UCAppProtectionCalculatorEnabled()) {
        if (![UCAppProtectionWindow.rootViewController isKindOfClass:DYYYUCAppProtectionCalculatorViewController.class]) {
            DYYYUCAppProtectionCalculatorViewController *calculator = [DYYYUCAppProtectionCalculatorViewController new];
...
+ (void)showBiometricWindowWithStatus:(NSString *)status {
    DYYYUCAppProtectionBiometricViewController *biometric = nil;
    if ([UCAppProtectionWindow.rootViewController isKindOfClass:DYYYUCAppProtectionBiometricViewController.class]) {
        biometric = (DYYYUCAppProtectionBiometricViewController *)UCAppProtectionWindow.rootViewController;
    } else {
        biometric = [DYYYUCAppProtectionBiometricViewController new];
        __weak typeof(self) weakSelf = self;
...
@implementation DYYYUCAppProtectionSettingsViewController
...
- (void)biometricSwitchChanged:(UISwitch *)sender {
    if (!sender.on) {
        ...
        UCAppProtectionLocked = NO;
        UCAppProtectionDidUnlockCurrentSession = YES;
        [DYYYUCAppProtectionTool dismissLockWindow];
        return;
    }
...
@implementation DYYYUCAppProtectionBiometricViewController
...
@implementation DYYYUCAppProtectionCalculatorViewController
