...
@interface DYYYFLEXDoKitMockViewController () <UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NSMutableArray *mockRules;
@property (nonatomic, strong) UISwitch *mockSwitch;
@end

@implementation DYYYFLEXDoKitMockViewController
...
- (void)mockSwitchChanged:(UISwitch *)sender {
    if (sender.on) {
        [[DYYYFLEXDoKitNetworkMonitor sharedInstance] enableMockMode];
        // 添加所有启用的Mock规则
        ...
        [[DYYYFLEXDoKitNetworkMonitor sharedInstance] disableMockMode];
    }
}
