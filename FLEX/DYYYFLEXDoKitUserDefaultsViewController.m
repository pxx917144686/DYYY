...
@interface DYYYFLEXDoKitUserDefaultsViewController () <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>  // ✅ 添加UISearchBarDelegate协议
...
@implementation DYYYFLEXDoKitUserDefaultsViewController
