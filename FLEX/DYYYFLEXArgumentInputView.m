...
@interface DYYYFLEXArgumentInputView ()
...
@implementation DYYYFLEXArgumentInputView
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        ...
        _titleLabel.textColor = DYYYFLEXColor.primaryTextColor;
