...
@interface DYYYFLEXExplorerToolbarItem ()

@property (nonatomic) DYYYFLEXExplorerToolbarItem *sibling;
...
@implementation DYYYFLEXExplorerToolbarItem
...
+ (instancetype)itemWithTitle:(NSString *)title image:(UIImage *)image sibling:(DYYYFLEXExplorerToolbarItem *)backupItem {
    NSParameterAssert(title); NSParameterAssert(image);
    
    DYYYFLEXExplorerToolbarItem *toolbarItem = [self buttonWithType:UIButtonTypeCustom];
    toolbarItem.sibling = backupItem;
    toolbarItem.title = title;
    toolbarItem.image = image;
    toolbarItem.tintColor = DYYYFLEXColor.iconColor;
    ...
    [toolbarItem setTitleColor:DYYYFLEXColor.primaryTextColor forState:UIControlStateNormal];
    [toolbarItem setTitleColor:DYYYFLEXColor.deemphasizedTextColor forState:UIControlStateDisabled];
    return toolbarItem;
}

- (DYYYFLEXExplorerToolbarItem *)currentItem {
...
+ (UIColor *)highlightedBackgroundColor {
    return DYYYFLEXColor.toolbarItemHighlightedColor;
}

+ (UIColor *)selectedBackgroundColor {
    return DYYYFLEXColor.toolbarItemSelectedColor;
}
