...
@interface DYYYFLEXMetadataSection ()
...
@implementation DYYYFLEXMetadataSection
...
- (id)initWithExplorer:(DYYYFLEXObjectExplorer *)explorer kind:(FLEXMetadataKind)metadataKind {
    self = [super init];
    if (self) {
        _explorer = explorer;
...
- (NSArray<UIMenuElement *> *)menuItemsForRow:(NSInteger)row sender:(UIViewController *)sender {
    ...
    [menuItems addObject:[UIAction
        ...
        handler:^(__kindof UIAction *action) {
            [sender.navigationController pushViewController:[DYYYFLEXObjectExplorerFactory
