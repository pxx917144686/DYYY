//
//  DYYYFLEXPerformanceViewController.m
//  FLEX
//
...
@interface DYYYFLEXPerformanceViewController ()
...
@implementation DYYYFLEXPerformanceViewController
...
- (void)viewDidLoad {
    ...
    // 启动性能监控
    [[DYYYFLEXPerformanceMonitor sharedInstance] startAllMonitoring];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    if ([self isMovingFromParentViewController] || [self isBeingDismissed]) {
        [[DYYYFLEXPerformanceMonitor sharedInstance] stopAllMonitoring];
    }
}
...
- (void)updateUI {
    DYYYFLEXPerformanceMonitor *monitor = [DYYYFLEXPerformanceMonitor sharedInstance];
