...
@class DYYYFLEXIvarBuilder, DYYYFLEXMethodBase, DYYYFLEXProperty, DYYYFLEXProtocol;


#pragma mark DYYYFLEXClassBuilder
@interface DYYYFLEXClassBuilder : NSObject
...
- (NSArray<DYYYFLEXMethodBase *> *)addMethods:(NSArray<DYYYFLEXMethodBase *> *)methods;
/// @return Any properties that failed to be added.
- (NSArray<DYYYFLEXProperty *> *)addProperties:(NSArray<DYYYFLEXProperty *> *)properties;
/// @return Any protocols that failed to be added.
- (NSArray<DYYYFLEXProtocol *> *)addProtocols:(NSArray<DYYYFLEXProtocol *> *)protocols;
/// @warning Adding Ivars to existing classes is not supported and will always fail.
- (NSArray<DYYYFLEXIvarBuilder *> *)addIvars:(NSArray<DYYYFLEXIvarBuilder *> *)ivars;
...
#pragma mark DYYYFLEXIvarBuilder
@interface DYYYFLEXIvarBuilder : NSObject
...
#define FLEXIvarBuilderWithNameAndType(nameString, type) [DYYYFLEXIvarBuilder \
    name:nameString \
    size:sizeof(type) \
