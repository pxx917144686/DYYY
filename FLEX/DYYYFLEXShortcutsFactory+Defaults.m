//
//  DYYYFLEXShortcutsFactory+Defaults.m
//  FLEX
//
...
#import "DYYYFLEXShortcutsFactory+Defaults.h"
...
@implementation DYYYFLEXShortcutsFactory (UIApplication)
...
@implementation DYYYFLEXShortcutsFactory (Views)
...
@implementation DYYYFLEXShortcutsFactory (ViewControllers)
...
@implementation DYYYFLEXShortcutsFactory (UIImage)
...
@implementation DYYYFLEXShortcutsFactory (NSBundle)
...
@implementation DYYYFLEXShortcutsFactory (Classes)
...
@implementation DYYYFLEXShortcutsFactory (Activities)
...
@implementation DYYYFLEXShortcutsFactory (Blocks)
...
@implementation DYYYFLEXShortcutsFactory (Foundation)
...
@implementation DYYYFLEXShortcutsFactory (WebKit_Safari)
...
@implementation DYYYFLEXShortcutsFactory (Pasteboard)
...
@implementation DYYYFLEXShortcutsFactory (FirebaseFirestore)
