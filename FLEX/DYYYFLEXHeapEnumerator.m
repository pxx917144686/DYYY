...
@implementation DYYYFLEXHeapEnumerator
...
+ (NSArray<DYYYFLEXObjectRef *> *)instancesOfClassWithName:(NSString *)className retained:(BOOL)retain {
    const char *classNameCString = className.UTF8String;
    NSMutableArray *instances = [NSMutableArray new];
    [DYYYFLEXHeapEnumerator enumerateLiveObjectsUsingBlock:^(__unsafe_unretained id object, __unsafe_unretained Class actualClass) {
    ...
    NSArray<DYYYFLEXObjectRef *> *references = [DYYYFLEXObjectRef referencingAll:instances retained:retain];
    return references;
}

+ (NSArray<DYYYFLEXObjectRef *> *)objectsWithReferencesToObject:(id)object retained:(BOOL)retain {
    NSMutableArray<DYYYFLEXObjectRef *> *instances = [NSMutableArray new];
    [DYYYFLEXHeapEnumerator enumerateLiveObjectsUsingBlock:^(__unsafe_unretained id tryObject, __unsafe_unretained Class actualClass) {
            ...
            for (unsigned int ivarIndex = 0; ivarIndex < ivarCount; ivarIndex++) {
                ...
                if (typeEncoding.flex_typeIsObjectOrClass) {
                    ...
                    if (*fieldPointer == (uintptr_t)(__bridge void *)object) {
                        ...
                        id ref = [DYYYFLEXObjectRef referencing:tryObject ivar:ivarName retained:retain];
...
+ (DYYYFLEXHeapSnapshot *)generateHeapSnapshot {
    ...
    [DYYYFLEXHeapEnumerator enumerateLiveObjectsUsingBlock:^(__unsafe_unretained id object, __unsafe_unretained Class cls) {
    ...
    return [DYYYFLEXHeapSnapshot snapshotWithCounts:countsForClassNames sizes:sizesForClassNames];
}
