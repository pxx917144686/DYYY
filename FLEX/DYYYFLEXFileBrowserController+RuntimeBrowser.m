...
@implementation DYYYFLEXFileBrowserController (RuntimeBrowser)
...
- (void)analyzeRuntimeMachOFile:(NSString *)path {
    ...
    if (handle) {
        ...
        DYYYFLEXMachOClassBrowserViewController *classBrowser = [[DYYYFLEXMachOClassBrowserViewController alloc] init];
...
- (void)analyzePlistFile:(NSString *)path {
    ...
    // 使用对象浏览器显示plist内容
    UIViewController *objectExplorer = [DYYYFLEXObjectExplorerFactory explorerViewControllerForObject:plistObject];
...
- (void)previewTextFile:(NSString *)path {
    ...
    // 使用Web视图显示文本内容
    DYYYFLEXWebViewController *webViewController = [[DYYYFLEXWebViewController alloc] initWithText:content];
