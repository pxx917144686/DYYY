...
@interface DYYYFLEXDoKitCrashInfo : NSObject
...
@interface DYYYFLEXDoKitCrashMonitor : NSObject

@property (nonatomic, strong, readonly) NSMutableArray<DYYYFLEXDoKitCrashInfo *> *crashLogs;
