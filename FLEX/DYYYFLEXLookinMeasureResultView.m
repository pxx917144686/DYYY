...
@interface DYYYFLEXLookinMeasureResultHorLineData : NSObject
...
@interface DYYYFLEXLookinMeasureResultVerLineData : NSObject
...
@implementation DYYYFLEXLookinMeasureResultHorLineData
@end

@implementation DYYYFLEXLookinMeasureResultVerLineData
@end

@interface DYYYFLEXLookinMeasureResultView ()
...
@implementation DYYYFLEXLookinMeasureResultView
...
- (void)renderLinesAndLabels {
    ...
    // 创建测量数据数组
    NSMutableArray<DYYYFLEXLookinMeasureResultHorLineData *> *horDatas = [NSMutableArray array];
    NSMutableArray<DYYYFLEXLookinMeasureResultVerLineData *> *verDatas = [NSMutableArray array];
...
- (void)addHorLineData:(NSMutableArray *)horDatas 
    ...
    DYYYFLEXLookinMeasureResultHorLineData *data = [DYYYFLEXLookinMeasureResultHorLineData new];
    data.startX = startX;
    data.endX = endX;
    data.y = y;
...
- (void)addVerLineData:(NSMutableArray *)verDatas 
                ...
                startY:(CGFloat)startY 
                  endY:(CGFloat)endY 
          displayValue:(CGFloat)displayValue {
    DYYYFLEXLookinMeasureResultVerLineData *data = [DYYYFLEXLookinMeasureResultVerLineData new];
    data.x = x;
    data.startY = startY;
    data.endY = endY;
    data.displayValue = ABS(displayValue);
...
- (void)drawLinesWithHorData:(NSArray *)horDatas verData:(NSArray *)verDatas {
    ...
    // 绘制水平线
    for (DYYYFLEXLookinMeasureResultHorLineData *data in horDatas) {
    ...
    // 绘制垂直线
    for (DYYYFLEXLookinMeasureResultVerLineData *data in verDatas) {
