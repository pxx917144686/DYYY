//
//  DYYYFLEXSystemAnalyzerViewController.m
//  FLEX
//
...
#import "DYYYFLEXMemoryAnalyzer.h"
#import "DYYYFLEXRuntimeClient.h"
#import "DYYYFLEXPerformanceMonitor.h"
#import "UIBarButtonItem+FLEX.h"
#import "DYYYFLEXDetailViewController.h" // 添加导入

@interface DYYYFLEXSystemAnalyzerViewController ()
@property (nonatomic, strong) NSDictionary *systemAnalysis;
@property (nonatomic, strong) NSArray *sectionTitles;
@property (nonatomic, strong) NSArray *sectionData;
@end

@implementation DYYYFLEXSystemAnalyzerViewController
...
- (NSDictionary *)getCurrentSystemAnalysis {
    ...
    // 性能监控数据
    DYYYFLEXPerformanceMonitor *perfMonitor = [DYYYFLEXPerformanceMonitor sharedInstance];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([value isKindOfClass:[NSArray class]] || [value isKindOfClass:[NSDictionary class]]) {
        // 创建详细视图显示复杂数据
        DYYYFLEXDetailViewController *detailVC = [[DYYYFLEXDetailViewController alloc] init];
        detailVC.title = key;
        detailVC.data = value;
