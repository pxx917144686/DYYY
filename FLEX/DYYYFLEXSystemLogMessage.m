...
@implementation DYYYFLEXSystemLogMessage
...
+ (instancetype)logMessageFromASLMessage:(aslmsg)aslMessage {
    ...
    DYYYFLEXSystemLogMessage *message = [[self alloc] initWithDate:date sender:sender text:text messageID:identifier];
