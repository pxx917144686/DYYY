...
@interface DYYYFLEXDoKitNetworkHistoryViewController () <UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
@implementation DYYYFLEXDoKitNetworkHistoryViewController
