...
@class DYYYFLEXScopeCarousel, DYYYFLEXWindow, DYYYFLEXTableViewSection;
...
@interface DYYYFLEXTableViewController : UITableViewController <
...
@property (nonatomic) DYYYFLEXTableView *tableView;
...
@property (nonatomic) DYYYFLEXScopeCarousel *carousel;
...
/// self.view.window as a \c DYYYFLEXWindow
