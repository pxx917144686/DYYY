...
@interface DYYYFLEXSQLiteDatabaseManager : NSObject <FLEXDatabaseManager>

/// 包含最后一次操作的结果，可能是一个错误
@property (nonatomic, readonly) DYYYFLEXSQLResult *lastResult;
...
- (DYYYFLEXSQLResult *)executeStatement:(NSString *)statement arguments:(NSDictionary<NSString *, id> *)args;
