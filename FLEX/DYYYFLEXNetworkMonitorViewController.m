...
- (void)refreshData {
    self.networkRequests = [[[DYYYFLEXDoKitNetworkMonitor sharedInstance] networkRequests] copy];
    [self.tableView reloadData];
}

- (void)clearNetworkLogs {
    [[DYYYFLEXDoKitNetworkMonitor sharedInstance] clearAllNetworkRequests];
    [self refreshData];
}
...
- (void)showSettings {
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"MITM 抓包详情" 
        ...
        DYYYFLEXNetworkMITMViewController *mitmVC = [DYYYFLEXNetworkMITMViewController new];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"网络设置" 
                                             style:UIAlertActionStyleDefault 
                                           handler:^(UIAlertAction * _Nonnull action) {
        DYYYFLEXNetworkSettingsController *settingsVC = [DYYYFLEXNetworkSettingsController new];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"弱网模拟" 
                                             style:UIAlertActionStyleDefault 
                                           handler:^(UIAlertAction * _Nonnull action) {
        DYYYFLEXDoKitWeakNetworkViewController *weakVC = [DYYYFLEXDoKitWeakNetworkViewController new];
    ...
    [alert addAction:[UIAlertAction actionWithTitle:@"Mock 数据" 
                                             style:UIAlertActionStyleDefault 
                                           handler:^(UIAlertAction * _Nonnull action) {
        DYYYFLEXDoKitMockViewController *mockVC = [DYYYFLEXDoKitMockViewController new];
