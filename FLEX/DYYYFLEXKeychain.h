...
/// Error code specific to DYYYFLEXKeychain that can be returned in NSError objects.
...
@interface DYYYFLEXKeychain : NSObject
...
///
/// @note See the `NSString` constants declared in DYYYFLEXKeychain.h for a list of keys that
