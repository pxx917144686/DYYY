...
@interface DYYYFLEXPropertyAttributes : NSObject <NSCopying, NSMutableCopying> {
// 这些对于可变子类的功能是必要的
@protected
    NSUInteger _count;
...
#pragma mark DYYYFLEXPropertyAttributes
@interface DYYYFLEXMutablePropertyAttributes : DYYYFLEXPropertyAttributes
