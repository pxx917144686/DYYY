...
@interface DYYYFLEXKBToolbarButton ()
...
@implementation DYYYFLEXKBToolbarButton
...
+ (instancetype)buttonWithTitle:(NSString *)title action:(FLEXKBToolbarAction)eventHandler forControlEvents:(UIControlEvents)controlEvent {
    DYYYFLEXKBToolbarButton *newButton = [self buttonWithTitle:title];
...
- (BOOL)isEqual:(id)object {
    if ([object isKindOfClass:[DYYYFLEXKBToolbarButton class]]) {
...
@implementation DYYYFLEXKBToolbarSuggestedButton
