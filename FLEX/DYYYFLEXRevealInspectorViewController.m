...
@interface DYYYFLEXRevealInspectorViewController ()
...
@implementation DYYYFLEXRevealInspectorViewController
...
- (void)setupInspector {
    self.inspector = [DYYYFLEXRevealLikeInspector sharedInstance];
