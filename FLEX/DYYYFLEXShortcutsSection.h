...
@class DYYYFLEXProperty, DYYYFLEXIvar, DYYYFLEXMethod;
...
@interface DYYYFLEXShortcutsSection : DYYYFLEXTableViewSection <FLEXObjectInfoSection>
...
/// - 任何遵循 \c DYYYFLEXShortcut 的对象
/// - 一个 \c NSString
/// - 一个 \c DYYYFLEXProperty
/// - 一个 \c DYYYFLEXIvar
/// - 一个 \c DYYYFLEXMethodBase（当然包括 \c DYYYFLEXMethod）
...
@class DYYYFLEXShortcutsFactory;
typedef DYYYFLEXShortcutsFactory *_Nonnull(^FLEXShortcutsFactoryNames)(NSArray *names);
typedef void (^FLEXShortcutsFactoryTarget)(Class targetClass);

/// 下面的块属性的使用方式类似于 SnapKit 或 Masonry。
/// \c DYYYFLEXShortcutsSection.append.properties(@[@"frame",@"bounds"]).forClass(UIView.class);
///
/// 要在启动时安全地注册您自己的类，请子类化此类，
/// 重写 \c +load，并在 \c self 上调用适当的方法
@interface DYYYFLEXShortcutsFactory : NSObject
...
@property (nonatomic, readonly, class) DYYYFLEXShortcutsFactory *append;
@property (nonatomic, readonly, class) DYYYFLEXShortcutsFactory *prepend;
@property (nonatomic, readonly, class) DYYYFLEXShortcutsFactory *replace;
