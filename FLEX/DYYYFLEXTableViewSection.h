...
@class DYYYFLEXTableView;

NS_ASSUME_NONNULL_BEGIN

#pragma mark DYYYFLEXTableViewSection
...
/// 有些方法根本没有实现，必须由子类实现。
@interface DYYYFLEXTableViewSection : NSObject {
    @protected
    /// 默认未使用，根据需要使用
    NSString *_title;
...
/// 有关更多信息，请参见 \c DYYYFLEXTableView.h。
/// @return 默认为 nil。
...
/// 您可以返回 \c DYYYFLEXTableView.h 中的任何标识符
