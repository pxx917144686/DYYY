...
/// always go back and move it to \c DYYYFLEXMethodBase if we find we need to.
@interface DYYYFLEXMethod : DYYYFLEXMethodBase
...
/// Constructs an \c DYYYFLEXMethod for the given method on the given class.
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c DYYYFLEXMethod object, or \c nil if the
...
/// @param cls the class, or metaclass if this is a class method
/// @return The newly constructed \c DYYYFLEXMethod object, or \c nil \e if the
...
- (void)swapImplementations:(DYYYFLEXMethod *)method;
...
@interface DYYYFLEXMethod (Comparison)

- (NSComparisonResult)compare:(DYYYFLEXMethod *)method;
